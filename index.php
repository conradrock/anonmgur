...
<meta name="Author" content="vaska94@avoe.ge" />
...
<div id="wrap">
	...
	<div id="header">			
		...
		<p id="slogan"><?php print $title; ?> - The Anonymous Image Sharer</p>		
    ...
    if(in_array(strtolower($matches[1]), $accepted)) {
        ...
        if($_FILES['file']['size'] <= $maxsize) {
          ...
          <img src="'.$imgurl.'" height="300" alt="Uploaded Picture" >
            ...
            print '<p>Sorry, Max Picture size is 4Mb</p>';

    } else

        print '<p>Filetype Not Allowed. RU hax0ring? ^__^ </p>';
...
<label for="file">Picture Upload: </label><input type="file" name="file" id="file" />(Max Pic. Size is 4MB)<br />
